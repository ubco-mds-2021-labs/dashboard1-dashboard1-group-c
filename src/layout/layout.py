...
row1 = html.Div([dbc.Row([
    ...
    dbc.Col(html.Iframe(srcDoc=pie_chart(), id='model', style={'border-width': '0', 'width': '200%', 'height': '400px'}), width=4)]
),
],
    className='row',
...
row2 = html.Div([dbc.Row([
    ...
    dbc.Col(map, width=4),
    dbc.Col(html.Iframe(srcDoc=line_chart(), style={'border-width': '0', 'width': '150%', 'height': '400px', 'align-items': 'end'}, id="time-plot"), width=3)]
),
],
    className='row',
    style={'height': '30%', 'background-color': 'white', "padding-left": "20px"}
